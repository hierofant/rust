...
public abstract class BaseModularVehicle : GroundVehicle, PlayerInventory.ICanMoveFrom, IPrefabPreProcess
{
	...
	{
		using (TimeWarning.New("BaseModularVehicle.VehicleFixedUpdate"))
		{
			...
			using FlagsUpdateScope flagsUpdateScope = StartSetFlags(FlagsUpdateMode.SendNetworkUpdate);
			flagsUpdateScope.Set(Flags.Reserved6, rigidBody.isKinematic);
		}
	}
	...
	{
		if (item.info.GetComponent<ItemModVehicleChassis>() != null)
		{
