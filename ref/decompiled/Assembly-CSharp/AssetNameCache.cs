...
public static class AssetNameCache
{
	...
	public static string GetName(this PhysicsMaterial mat)
	{
		return LookupName(mat);
	}

	public static string GetNameLower(this PhysicsMaterial mat)
	{
		return LookupNameLower(mat);
	}

	public static string GetNameUpper(this PhysicsMaterial mat)
	{
