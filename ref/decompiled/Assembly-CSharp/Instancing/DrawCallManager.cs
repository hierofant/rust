	...
	private void SubmitDrawCallsInternal(Camera camera)
	{
		...
		for (int i = 0; i < DrawCalls.Count; i++)
		{
			...
			else
			{
				...
				UnityEngine.Graphics.DrawMeshInstancedIndirect(drawCall.Mesh, drawCall.SubmeshIndex, drawCall.Material, cullingBounds, IndirectArgsBuffer.Buffer, argsOffset, drawCall.MaterialBlock, drawCall.ShadowMode, drawCall.ReceiveShadows, 2097152, camera, drawCall.LightProbes);
			}
		}
