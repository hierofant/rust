...
public class BradleySpawner : MonoBehaviour, IServerComponent
{
	...
	public void ScheduleRespawn()
	{
		...
		SingletonComponent<InvokeHandler>.Instance.Invoke(DoRespawn, UnityEngine.Random.Range(Bradley.respawnDelayMinutes - Bradley.respawnDelayVariance, Bradley.respawnDelayMinutes + Bradley.respawnDelayVariance) * 60f);
		pendingRespawn = true;
	}
	...
	public void SpawnBradley()
	{
		...
		{
			Vector3 position = path.interestZones[UnityEngine.Random.Range(0, path.interestZones.Count)].Position;
