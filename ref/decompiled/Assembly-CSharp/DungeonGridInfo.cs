...
public class DungeonGridInfo : LandmarkInfo
{
	...
	public bool IsValidSpawnPosition(Vector3 position)
	{
		...
		Vector3 vector = WorldSpaceGrid.ClosestGridCell(bounds.position, TerrainMeta.Size.x, CellSize, WorldSpaceGrid.RoundingMode.Down);
	...
	{
		World.TrackSpawnedPrefab("Dungeon", base.gameObject);
	}
}
