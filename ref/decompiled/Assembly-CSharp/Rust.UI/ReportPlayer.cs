...
public class ReportPlayer : UIDialog
{
	...
	public static Option[] ReportReasons = new Option[6]
	{
		...
		new Option(new Translate.Phrase("report.reason.server_rules", "Breaking Server Rules"), "break_server_rules", isdefault: false, Icons.ExclamationCircle)
	};
}
