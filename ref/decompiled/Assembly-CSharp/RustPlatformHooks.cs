...
public class RustPlatformHooks : IPlatformHooks
{
	...
	public ServerParameters? ServerParameters
	{
		get
		{
			...
			return new ServerParameters("rust", "Rust", 2633.ToString(), Network.Net.sv.secure, CommandLine.HasSwitch("-sdrnet"), address, (ushort)Network.Net.sv.port, (ushort)ConVar.Server.queryport);
		}
	}
