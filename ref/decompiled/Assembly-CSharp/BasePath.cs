...
public class BasePath : MonoBehaviour, IAIPath
{
	...
	public ReadOnlySpan<IAIPathInterestNode> InterestNodes => interestZones.ListAsReadOnlySpanOf<PathInterestNode, IAIPathInterestNode>();

	public ReadOnlySpan<IAIPathSpeedZone> SpeedZones => speedZones.ListAsReadOnlySpanOf<PathSpeedZone, IAIPathSpeedZone>();
	...
	public IAIPathInterestNode GetRandomInterestNodeAwayFrom(Vector3 from, float dist = 10f)
	{
		...
		{
			iAIPathInterestNode = interestZones[UnityEngine.Random.Range(0, interestZones.Count)];
		...
		if (iAIPathInterestNode == null)
		{
			...
			iAIPathInterestNode = interestZones[0];
		}
