...
public class Spawnable : MonoBehaviour, IServerComponent
{
	...
	private void Add()
	{
		...
		else if (Rust.Application.isLoading && !Rust.Application.isLoadingSave)
		{
			...
			if (component != null && component.enableSaving && !component.syncPosition && (!TryGetComponent<SpawnPointInstance>(out var component2) || !component2.blockSpawnHandlerRespawns))
			{
