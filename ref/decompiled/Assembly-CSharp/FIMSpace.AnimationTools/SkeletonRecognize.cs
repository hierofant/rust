...
public static class SkeletonRecognize
{
	...
	public class SkeletonInfo
	{
		...
		public string GetLog()
		{
			...
			text += "\nGenerate Guides:\n";
			text = text + "Highest: " + LocalSpaceHighest.ToString() + "     ";
			text = text + "Lowest: " + LocalSpaceLowest.ToString() + "     ";
			text = text + "Left: " + LocalSpaceMostLeft.ToString() + "     ";
			text = text + "Right: " + LocalSpaceMostRight.ToString() + "     ";
			text = text + "Forward: " + LocalSpaceMostForward.ToString() + "     ";
			text = text + "Back: " + LocalSpaceMostBack.ToString() + "     ";
