...
public class SpinnerWheel : Signage
{
	...
	{
		base.ServerInit();
		wheelHandle = wheel.transformHandle;
	}
	...
	public override void Save(SaveInfo info)
	{
		...
		Quaternion quaternion = ((!BaseNetworkable.UseParallelSaves) ? wheel.localRotation : Facepunch.Extend.TransformEx.Unsafe.GetLocalRotMT(in wheelHandle));
		info.msg.spinnerWheel.spin = quaternion.eulerAngles;
	}
	...
	private void ToggleChildEntityColliders(bool state)
	{
		...
		{
			if (child is DroppedItem droppedItem && droppedItem.childCollider != null)
			{
