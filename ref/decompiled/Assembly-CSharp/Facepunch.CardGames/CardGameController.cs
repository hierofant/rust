...
public abstract class CardGameController : IDisposable
{
	...
	public readonly CardGame.CardList localPlayerCards;
	...
	public CardGameController(BaseCardGameEntity owner)
	{
		...
		resultInfo.results = Pool.Get<List<CardGame.RoundResults.Result>>();
	...
	protected void SyncLocalPlayerCards(CardPlayerData pData)
	{
		...
		if (basePlayer == null || !pData.HasUserInGame)
		{
			return;
		}
	...
	{
		syncData.players = Pool.Get<List<CardGame.CardPlayer>>();
