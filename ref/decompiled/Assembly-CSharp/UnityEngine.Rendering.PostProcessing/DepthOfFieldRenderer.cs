...
internal sealed class DepthOfFieldRenderer : PostProcessEffectRenderer<DepthOfField>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		command.BlitFullscreenTriangle(BuiltinRenderTextureType.None, UnityEngine.Rendering.PostProcessing.ShaderIDs.CoCTex, propertySheet, 0);
		if (context.IsTemporalAntialiasingActive() || context.dlssEnabled)
		{
			...
			propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.TaaParams, new Vector3(texelOffset.x, texelOffset.y, z));
		...
		command.BlitFullscreenTriangle(context.source, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, propertySheet, 2);
		...
		command.BlitFullscreenTriangle(UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTemp, propertySheet, (int)(3 + base.settings.kernelSize.value));
		command.BlitFullscreenTriangle(UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTemp, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, propertySheet, 7);
