...
public sealed class HistogramMonitor : Monitor
{
	...
	internal override void Render(PostProcessRenderContext context)
	{
		...
		command.SetComputeTextureParam(gammaHistogram, kernelIndex, "_Source", UnityEngine.Rendering.PostProcessing.ShaderIDs.HalfResFinalCopy);
		command.SetComputeBufferParam(gammaHistogram, kernelIndex, "_HistogramBuffer", m_Data);
		...
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Params, new Vector4(width, height, 0f, 0f));
		propertySheet.properties.SetBuffer(UnityEngine.Rendering.PostProcessing.ShaderIDs.HistogramBuffer, m_Data);
