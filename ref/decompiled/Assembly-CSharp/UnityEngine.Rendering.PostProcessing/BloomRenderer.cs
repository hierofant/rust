...
internal sealed class BloomRenderer : PostProcessEffectRenderer<Bloom>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		propertySheet.properties.SetFloat(UnityEngine.Rendering.PostProcessing.ShaderIDs.SampleScale, num10);
		...
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Threshold, value);
		float x = Mathf.GammaToLinearSpace(base.settings.clamp.value);
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Params, new Vector4(x, 0f, 0f, 0f));
		...
		for (int num15 = num9 - 2; num15 >= 0; num15--)
		{
			...
			command.SetGlobalTexture(UnityEngine.Rendering.PostProcessing.ShaderIDs.BloomTex, down2);
		...
		{
			propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.ColorIntensity, new Vector4(linear.r, linear.g, linear.b, num16));
		...
		uberSheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Bloom_DirtTileOffset, value3);
		uberSheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Bloom_Settings, value2);
		uberSheet.properties.SetColor(UnityEngine.Rendering.PostProcessing.ShaderIDs.Bloom_Color, linear);
		uberSheet.properties.SetTexture(UnityEngine.Rendering.PostProcessing.ShaderIDs.Bloom_DirtTex, texture);
		command.SetGlobalTexture(UnityEngine.Rendering.PostProcessing.ShaderIDs.BloomTex, num14);
