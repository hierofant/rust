...
public sealed class SubpixelMorphologicalAntialiasing
{
	...
	internal void Render(PostProcessRenderContext context)
	{
		...
		command.BlitFullscreenTriangle(context.source, UnityEngine.Rendering.PostProcessing.ShaderIDs.SMAA_Flip, propertySheet, (int)quality, clear: true);
		command.BlitFullscreenTriangle(UnityEngine.Rendering.PostProcessing.ShaderIDs.SMAA_Flip, UnityEngine.Rendering.PostProcessing.ShaderIDs.SMAA_Flop, propertySheet, (int)(3 + quality));
