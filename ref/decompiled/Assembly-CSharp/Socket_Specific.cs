...
public class Socket_Specific : Socket_Base
{
	...
	public override bool TestTarget(Construction.Target target)
	{
		...
		if (blockPlacementOnChildEntities && target.entity != null && SocketMod_BoatBuildingBlock.Contained(target.entity.transform.position, 2f, 134217728, QueryTriggerInteraction.Ignore, requireHull: false, requireNoParentBoat: true, out var _))
		{
			return false;
		}
	...
	public override Construction.Placement DoPlacement(Construction.Target target)
	{
		...
		if (canRotate)
		{
			quaternion3 *= Quaternion.Euler(target.rotation);
		}
