	...
	protected override bool WriteSyncVar(byte id, NetWrite writer)
	{
		...
		case 0:
			if (ConVar.Global.developer > 2)
			{
				...
				Debug.Log("SyncVar Writing: FuelAmountSync for " + iD.ToString());
			}
		...
		case 1:
			...
			{
				NetworkableId iD = net.ID;
				Debug.Log("SyncVar Writing: NumConnectedCarsSync for " + iD.ToString());
			}
		...
		case 2:
			...
			{
				NetworkableId iD = net.ID;
				Debug.Log("SyncVar Writing: LinedUpToUnloadSync for " + iD.ToString());
			}
