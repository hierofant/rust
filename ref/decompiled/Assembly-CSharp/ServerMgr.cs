...
public class ServerMgr : SingletonComponent<ServerMgr>, IServerCallback
{
	...
	private static readonly Memoized<string, (bool Server, bool Player)> _systemConfigTag = new Memoized<string, (bool, bool)>(((bool Server, bool Player) t) => (!t.Server && !t.Player) ? null : $",sc{(t.Player ? 2 : 0) | (t.Server ? 1 : 0)}");
	...
	public static readonly Translate.Phrase SERVER_RESTARTING = new Translate.Phrase("server.restarting", "Server Restarting!");

	public static readonly Translate.Phrase RESTART_INTERRUPTED_PHRASE = new Translate.Phrase("server.restart_interrupted", "Server Restart interrupted!");
	...
	public void OnNetworkMessage(Message packet)
	{
		...
		case Message.Type.Ready:
			...
			using (packet.read.UseProtoDeserializationLimits())
			{
	...
	public BasePlayer SpawnNewPlayer(Network.Connection connection)
	{
		...
		if (connection != null)
		{
			...
			DebugEx.Log($"{basePlayer.displayName} with steamid {basePlayer.userID.Get()} joined from ip {basePlayer.net.connection.ipaddress} with platform {basePlayer.net.connection.os}");
	...
	private void OnGiveUserInformation(Message packet)
	{
		...
		{
			DebugEx.Log("Kicking " + packet.connection?.ToString() + " - their protocol is " + packet.connection.protocol + " not " + 2633);
	...
	public void OpenConnection(bool useSteamServer = true)
	{
		...
		if (Facepunch.CommandLine.HasSwitch("-insecure"))
		{
			...
			Network.Net.sv.encryption = Mathf.Clamp(ConVar.Server.encryption, 0, 1);
		}
	...
	public void CreateDeepSea()
	{
		...
		if (!DeepSea.enabled)
		{
			ConVar.Physics.SetBounds(ConVar.Physics.DeepSeaDisabledBounds);
		}
		else
		{
			ConVar.Physics.SetBounds(ConVar.Physics.DeepSeaEnabledBounds);
		}
	}
	...
	private void Update()
	{
		...
		using (TimeWarning.New("ServerMgr.Update", 500))
		{
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: BuriedItems.DoUpdate");
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: File Request Queue");
			...
			try
			{
				using (TimeWarning.New("BasePlayer.ServerCycle"))
				{
					...
					try
					{
						...
						{
							AutoTurret.updateAutoTurretScanQueue.RunList(AutoTurret.scan_budget_ms);
						}
					}
					catch (Exception exception11)
					{
						UnityEngine.Debug.LogWarning("Server Exception: AutoTurret.BudgetedUpdate.Scan");
					...
					try
					{
						...
						{
							AutoTurret.updateAutoTurretAmmoQueue.RunQueue(AutoTurret.ammo_update_ms);
						}
					}
					catch (Exception exception12)
					{
						UnityEngine.Debug.LogWarning("Server Exception: AutoTurret.BudgetedUpdate.Ammo");
					...
					try
					{
						...
						{
							AutoTurret.updateTurretTick.RunQueue(AutoTurret.tick_update_ms);
						}
					}
					catch (Exception exception13)
					{
						UnityEngine.Debug.LogWarning("Server Exception: AutoTurret.BudgetedUpdate.Tick");
					...
					try
					{
						...
						{
							BeeSwarmAI.updateBeeSwarmThink.RunQueue(BeeSwarmAI.think_budget_ms);
						}
					}
					catch (Exception exception15)
					{
						UnityEngine.Debug.LogWarning("Server Exception: BeeSwarmAI.BudgetedUpdate");
					...
					try
					{
						...
						{
							BaseOven.cookQueue.RunList(ConVar.Server.ovenCookBudgetMs);
						}
					}
					catch (Exception exception18)
					{
						UnityEngine.Debug.LogWarning("Server Exception: BaseOven.BudgetedUpdate");
					...
					try
					{
						using (TimeWarning.New("ItemModFoodSpoiling.BudgetedUpdate"))
						{
							...
							{
								ItemModFoodSpoiling.foodSpoilItems.RunList(ConVar.Server.foodSpoilingBudgetMs);
							}
						}
					}
					catch (Exception exception19)
					{
						UnityEngine.Debug.LogWarning("Server Exception: ItemModFoodSpoiling.BudgetedUpdate");
					...
					try
					{
						...
						{
							CCTV_RC.WorkQueue.RunList(CCTV_RC.inputBudgetMs);
						}
					}
					catch (Exception exception20)
					{
						UnityEngine.Debug.LogWarning("Server Exception: CCTV_RC.BudgetedUpdate");
					...
					try
					{
						...
						{
							ElectricBattery.DischargeQueue.RunList(ElectricBattery.DischargeBudgetMs);
						}
					}
					catch (Exception exception21)
					{
						UnityEngine.Debug.LogWarning("Server Exception: ElectricBattery.DischargeQueue");
					...
					try
					{
						...
						{
							SolarPanel.WorkQueue.RunList(SolarPanel.sunUpdateBudgetMs);
						}
					}
					catch (Exception exception22)
					{
						UnityEngine.Debug.LogWarning("Server Exception: SolarPanel.SunUpdateWorkQueue");
					...
					try
					{
						...
						{
							WaterCatcher.CollectWorkQueue.RunList(WaterCatcher.WaterCatcherBudgetMs);
						}
					}
					catch (Exception exception23)
					{
						UnityEngine.Debug.LogWarning("Server Exception: WaterCatcher.CollectWorkQueue");
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: RustNavigation.Tick");
			...
			try
			{
				...
				{
					FSMComponent.workQueue.RunList(1.0);
				}
			}
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: RustNavMeshAgent.TickEnabledComponents");
			...
			if (aiTick == AIThinkManager.QueueType.Human)
			{
				...
				catch (Exception exception31)
				{
					...
					UnityEngine.Debug.LogException(exception31, this);
				}
				if (!AI.spliceupdates)
				{
			...
			if (aiTick == AIThinkManager.QueueType.Animal)
			{
				...
				catch (Exception exception32)
				{
					...
					UnityEngine.Debug.LogException(exception32, this);
				}
			}
			try
			{
			...
			catch (Exception exception33)
			{
				...
				UnityEngine.Debug.LogException(exception33, this);
			}
			try
			{
			...
			catch (Exception exception34)
			{
				...
				UnityEngine.Debug.LogException(exception34, this);
			}
			try
			{
			...
			catch (Exception exception35)
			{
				...
				UnityEngine.Debug.LogException(exception35, this);
			}
			try
			{
			...
			catch (Exception exception36)
			{
				...
				UnityEngine.Debug.LogException(exception36, this);
			}
			try
			{
			...
			catch (Exception exception37)
			{
				...
				UnityEngine.Debug.LogException(exception37, this);
			}
			try
			{
				using (TimeWarning.New("JunkPileWater.UpdateNearbyPlayers"))
				{
					JunkPileWater.junkpileWaterWorkQueue.RunList(JunkPileWater.framebudgetms);
				}
			}
			catch (Exception exception38)
			{
				UnityEngine.Debug.LogWarning("Server Exception: JunkPileWater.UpdateNearbyPlayers");
				UnityEngine.Debug.LogException(exception38, this);
			}
			try
			{
			...
			catch (Exception exception39)
			{
				...
				UnityEngine.Debug.LogException(exception39, this);
			}
			try
			{
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: PowergridManager.StageChangeWorkQueue");
				UnityEngine.Debug.LogException(exception40, this);
			}
			try
			{
				using (TimeWarning.New("Hopper.WorkQueue"))
				{
					Hopper.WorkQueue.RunList(ConVar.Server.hopperAnimationBudgetMs);
				}
			}
			catch (Exception exception41)
			{
				UnityEngine.Debug.LogWarning("Server Exception: Hopper.WorkQueue");
				UnityEngine.Debug.LogException(exception41, this);
			}
			try
			{
			...
			catch (Exception exception42)
			{
				...
				UnityEngine.Debug.LogException(exception42, this);
			}
			try
			{
			...
			catch (Exception exception43)
			{
				...
				UnityEngine.Debug.LogException(exception43, this);
			}
			try
			{
				using (TimeWarning.New("ChickenCoop.CoopWorkQueue"))
				{
					ChickenCoop.CoopWorkQueue.RunQueue(0.10000000149011612);
				}
			}
			catch (Exception exception44)
			{
				UnityEngine.Debug.LogWarning("Server Exception: ChickenCoop.CoopWorkQueue");
				UnityEngine.Debug.LogException(exception44, this);
			}
			try
			{
				using (TimeWarning.New("FarmableAnimal.NeedsWorkQueue"))
				{
					FarmableAnimal.NeedsWorkQueue.RunQueue(0.10000000149011612);
				}
			}
			catch (Exception exception45)
			{
				UnityEngine.Debug.LogWarning("Server Exception: FarmableAnimal.NeedsWorkQueue");
				UnityEngine.Debug.LogException(exception45, this);
			}
			try
			{
				using (TimeWarning.New("Chicken.EggWorkQueue"))
				{
					Chicken.EggWorkQueue.RunQueue(0.10000000149011612);
				}
			}
			catch (Exception exception46)
			{
				UnityEngine.Debug.LogWarning("Server Exception: Chicken.EggWorkQueue");
				UnityEngine.Debug.LogException(exception46, this);
			}
			try
			{
				using (TimeWarning.New("IndustrialStorageAdaptor.SortQueue"))
				{
					IndustrialStorageAdaptor.SortQueue.RunQueue(0.10000000149011612);
				}
			}
			catch (Exception exception47)
			{
				UnityEngine.Debug.LogWarning("Server Exception: IndustrialStorageAdaptor.SortQueue");
				UnityEngine.Debug.LogException(exception47, this);
			}
			try
			{
				using (TimeWarning.New("BasePlayer.RelationshipUpdateQueue"))
				{
					...
					{
						BasePlayer.relationshipUpdateQueue.RunList(BasePlayer.relationshipUpdateQueueFrameBudgetMs);
					}
				}
			}
			catch (Exception exception48)
			{
				UnityEngine.Debug.LogWarning("Server Exception: BasePlayer.RelationshipUpdateQueue");
				UnityEngine.Debug.LogException(exception48, this);
				throw;
			}
			try
			{
			...
			{
				UnityEngine.Debug.LogWarning("Server Exception: TriggerParent.RunOnTick");
				UnityEngine.Debug.LogException(exception49, this);
			}
			try
			{
				using (TimeWarning.New("BaseMission.UpdateMissionValidStateWorkQueue"))
				{
					BaseMission.updateMissionValidStateWorkQueue.RunQueue(BaseMission.missionValidStateWorkQueueBudget);
				}
			}
			catch (Exception exception50)
			{
				UnityEngine.Debug.LogWarning("Server Exception: BaseMission.UpdateMissionValidStateWorkQueue");
				UnityEngine.Debug.LogException(exception50, this);
			}
		}
		try
		{
			...
			{
				BoatAI.BoatWorkQueue.RunQueue(BoatAI.boat_ai_frame_budget_ms);
			}
		}
		catch (Exception exception51)
		{
			UnityEngine.Debug.LogWarning("Server Exception: BoatAI.BoatWorkQueue");
			UnityEngine.Debug.LogException(exception51, this);
		}
		try
		{
			using (TimeWarning.New("ElectricWaterWheel.UpdateWorkQueue"))
			{
				ElectricWaterWheel.UpdateWorkQueue.RunList(ConVar.Server.waterWheelWorkBudgetMs);
			}
		}
		catch (Exception exception52)
		{
			UnityEngine.Debug.LogWarning("Server Exception: DisplayingBoxStorage.UpdateWorkQueue");
			UnityEngine.Debug.LogException(exception52, this);
		}
	...
	private void RecheckPremiumStatus()
	{
		...
		double num2 = UnityEngine.Time.realtimeSinceStartupAsDouble - (double)num;
		...
		obj.Sort((Network.Connection x, Network.Connection y) => x.lastPremiumCheckTime.CompareTo(y.lastPremiumCheckTime));
		int num3 = Mathf.Clamp(ConVar.Server.premiumRecheckMaxBatchSize, 10, 500);
		if (obj.Count > num3)
		{
			obj.RemoveRange(num3, obj.Count - num3);
		}
		RecheckPremiumStatusImpl(obj);
		static async void RecheckPremiumStatusImpl(List<Network.Connection> connections)
		{
			try
			{
				...
				foreach (Network.Connection connection3 in connections)
				{
					if (connection3.connected)
					{
						...
						{
							UnityEngine.Debug.LogWarning($"Missing premium status for {connection3.userid}");
						}
						else
						{
			...
			{
				UnityEngine.Debug.LogError("Error rechecking premium status for connected players");
				UnityEngine.Debug.LogException(exception);
			}
		}
	}
	...
	private void UpdateServerInformation()
	{
		...
		using (TimeWarning.New("UpdateServerInformation"))
		{
			...
			string text8 = _systemConfigTag.Get((ConVar.Server.useServerWideRequiredSystemConfig, ConVar.Server.usePerPlayerRequiredSystemConfig));
			string text9 = (NexusServer.Started ? ",nexuszone" : "");
			...
			if (NexusServer.Started)
			{
				...
				SteamServer.SetKey("nexus.zone", NexusServer.ZoneClient?.Zone?.ZoneId.ToString("G") ?? "");
			}
	...
	public static BasePlayer.SpawnPoint FindSpawnPoint(BasePlayer forPlayer = null, ulong teamId = 0uL)
	{
		...
		{
			GameObject gameObject = SingletonComponent<ServerMgr>.Instance.proceduralSpawnPoints[UnityEngine.Random.Range(0, SingletonComponent<ServerMgr>.Instance.proceduralSpawnPoints.Length)];
		...
		{
			GameObject gameObject2 = SingletonComponent<ServerMgr>.Instance.fallbackProceduralSpawnPoints[UnityEngine.Random.Range(0, SingletonComponent<ServerMgr>.Instance.fallbackProceduralSpawnPoints.Length)];
	...
	public void JoinGame(Network.Connection connection)
	{
		using (Approval approval = Facepunch.Pool.Get<Approval>())
		{
			...
			approval.dnsEndpoint = ConVar.Server.favoritesEndpoint;
			NetWrite netWrite = Network.Net.sv.StartWrite();
	...
	private static void ShowToastToAllClients(GameTip.Styles style, Translate.Phrase phrase, bool overlay = false, params string[] arguments)
	{
