...
public class CathodeRenderer : PostProcessEffectRenderer<Cathode>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		if ((float)base.settings.intensity > 0f)
		{
			...
			command.BlitFullscreenTriangle(context.source, _CathodeRT1, propertySheet, 0);
			command.BlitFullscreenTriangle(_CathodeRT1, _CathodeRT2, propertySheet2, 0);
			command.BlitFullscreenTriangle(_CathodeRT1, temporalRT, propertySheet5, 0);
			command.BlitFullscreenTriangle(_CathodeRT2, _CathodeRT1, propertySheet4, 0);
			command.BlitFullscreenTriangle(_CathodeRT1, context.destination, propertySheet3, 0);
