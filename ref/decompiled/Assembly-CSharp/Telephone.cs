...
public class Telephone : ContainerIOEntity, ICassettePlayer
{
	...
	public override void Save(SaveInfo info)
	{
		...
		{
			info.msg.telephone.voicemail = Facepunch.Pool.Get<List<ProtoBuf.VoicemailEntry>>();
	...
	public void OnCassetteRemoved(Cassette c)
	{
		...
		ClientRPC(RpcTarget.NetworkGroup("ClientOnCassetteChanged"), default(NetworkableId));
	}
	...
	public override void Load(LoadInfo info)
	{
		...
		Controller.savedVoicemail = Facepunch.Pool.Get<List<ProtoBuf.VoicemailEntry>>();
