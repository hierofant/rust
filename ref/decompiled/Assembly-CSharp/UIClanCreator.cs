...
public class UIClanCreator : BaseMonoBehaviour
{
	...
	public static readonly Translate.Phrase CreateNameInvalidLength = new TokenisedPhrase("clan.create.name_invalid_length", "Clan names must be between {0} and {1} characters long.");

	public static readonly Translate.Phrase CreateNameInvalidCharacters = new TokenisedPhrase("clan.create.name_invalid_characters", "Clan names can only contain letters, numbers, spaces, apostrophes, and hyphens.");
