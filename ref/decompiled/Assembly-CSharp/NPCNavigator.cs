...
public class NPCNavigator : BaseNavigator
{
	...
	private void UpdateRotation(Vector3 moveToPosition, float delta)
	{
		...
		{
			Vector3 vector = base.Agent.destinationWS - base.BaseEntity.ServerPosition;
		...
		else if ((base.Agent.destinationWS - base.BaseEntity.ServerPosition).sqrMagnitude > 1f)
		{
			Vector3 normalized = base.Agent.desiredVelocityWS.normalized;
