...
public class MonumentInfo : LandmarkInfo, IPrefabPreProcess
{
	...
	protected override void Awake()
	{
		...
		if ((bool)TerrainMeta.Path && !DeepSeaManager.IsInsideDeepSea(base.transform.position))
		{
	...
	public bool CheckPlacement(Vector3 pos, Quaternion rot, Vector3 scale, int minCorners = 3, bool allowAdjacentTier = false)
	{
		...
		WaterBody componentInChildren = GetComponentInChildren<WaterBody>();
		if (componentInChildren == null || componentInChildren.Type != WaterBodyType.Lake)
		{
			return true;
		}
