...
public abstract class BaseHelicopter : BaseVehicle, SeekerTarget.ISeekerTargetOwner
{
	...
	public override void VehicleFixedUpdate()
	{
		using (TimeWarning.New("BaseHelicopter.VehicleFixedUpdate"))
		{
			...
			{
				flagsUpdateScope.Set(Flags.Reserved6, TOD_Sky.Instance.IsNight);
			}
	...
	public void ProcessCollision(Collision collision)
	{
		...
		if ((bool)collision.gameObject)
		{
			...
			if (entity != null && (entity is Parachute || entity is RidableHorse || entity is MagnetCrane))
			{
				return;
			}
		}
		...
		rigidBody.AddForceAtPosition(collision.GetContact(0).normal * (1f + 3f * num) * rigidBody.mass, collision.GetContact(0).point, ForceMode.Impulse);
	...
	public override void OnDied(HitInfo info)
	{
		...
		Vector3 vector = rigidBody.linearVelocity * 0.25f;
