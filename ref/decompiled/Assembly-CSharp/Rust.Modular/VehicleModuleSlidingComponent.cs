...
public class VehicleModuleSlidingComponent
{
	...
	{
		using BaseEntity.FlagsUpdateScope flagsUpdateScope = parentModule.StartSetFlags(BaseEntity.FlagsUpdateMode.SendNetworkUpdate);
		flagsUpdateScope.Set(flag_SliderOpen, !WantsOpenPos(parentModule));
	}
