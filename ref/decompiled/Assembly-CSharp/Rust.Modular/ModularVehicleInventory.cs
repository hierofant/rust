...
public class ModularVehicleInventory : IDisposable
{
	...
	public ModularVehicleInventory(BaseModularVehicle vehicle, ItemDefinition chassisItemDef, bool giveUID)
	{
		...
		chassisContainer.onlyAllowedItems = new ItemDefinition[1] { chassisItemDef };
		vehicle.AssociatedItemInstance = ItemManager.Create(chassisItemDef, 1, 0uL, isServerSide: true, 0uL);
