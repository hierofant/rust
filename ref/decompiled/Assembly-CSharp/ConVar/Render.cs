...
public class Render : ConsoleSystem
{
	...
	[ClientVar(ClientAdmin = true, Help = "(Generated) Enables or disables shadow rendering globally on the client; disabling shadows significantly improves GPU performance")]
	...
	[ClientVar(Name = "show_building_blocked", Saved = true, Help = "(Generated) Shows a coloured overlay on building-blocked areas client-side, visualising where construction is prevented")]
	...
	[ClientVar(Name = "expand_instancing", ClientAdmin = true, Help = "(Generated) Forces GPU instancing to expand and rebatch a specific instancing group by name; useful for debugging instancing issues without restarting")]
