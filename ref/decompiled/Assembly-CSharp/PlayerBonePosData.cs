...
public class PlayerBonePosData : ScriptableObject
{
	...
	{
		if ((flagsOnDeath & BasePlayer.PlayerFlags.Sleeping) == BasePlayer.PlayerFlags.Sleeping)
		{
			return sleeping;
		}
		if ((flagsOnDeath & BasePlayer.PlayerFlags.Incapacitated) == BasePlayer.PlayerFlags.Incapacitated)
		{
			return incapacitated;
		}
		if ((flagsOnDeath & BasePlayer.PlayerFlags.Wounded) == BasePlayer.PlayerFlags.Wounded)
		{
			return crawling;
		}
