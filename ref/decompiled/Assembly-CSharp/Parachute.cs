...
public class Parachute : BaseVehicle, SamSite.ISamSiteTarget
{
	...
	public override void VehicleFixedUpdate()
	{
		using (TimeWarning.New("Parachute.VehicleFixedUpdate"))
		{
			...
			rigidBody.mass = mass;
			rigidBody.linearDamping = Mathf.Lerp(0f, TargetDrag * num2, t);
			rigidBody.angularDamping = Mathf.Lerp(0f, TargetAngularDrag * num2, t);
			...
			if (triggerParachuteForceVolume != null)
			{
				force *= triggerParachuteForceVolume.GetSpeedMultiplierForParachute(this);
			}
			...
			linearVelocity.x = Mathf.Clamp(linearVelocity.x, 0f - num4, num4);
			linearVelocity.z = Mathf.Clamp(linearVelocity.z, 0f - num4, num4);
	...
	public void ProcessDeath()
	{
		...
		if (num2 && !BypassRepack)
		{
			...
			if (parachuteUnpacked != null)
			{
				...
				{
					component.linearVelocity = rigidBody.linearVelocity;
				}
			}
		}
