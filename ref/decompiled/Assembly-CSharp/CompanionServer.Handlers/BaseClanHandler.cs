...
public abstract class BaseClanHandler<T> : BasePlayerHandler<T> where T : class
{
	...
	private static string GetErrorString(ClanResult result)
	{
		return result switch
		{
			...
			ClanResult.InvalidText_Empty => "clan_invalid_text_empty", 
			ClanResult.InvalidText_TooShort => "clan_invalid_text_too_short", 
			ClanResult.InvalidText_TooLong => "clan_invalid_text_too_long", 
			ClanResult.InvalidText_InvalidCharacters => "clan_invalid_text_invalid_characters", 
			ClanResult.InvalidText_Generic => "clan_invalid_text", 
