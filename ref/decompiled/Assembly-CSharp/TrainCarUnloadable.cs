...
public class TrainCarUnloadable : TrainCar
{
	...
	public override void OnFlagsChanged(Flags old, Flags next)
	{
		...
		if ((old & Flags.Reserved4) == Flags.Reserved4 != ((next & Flags.Reserved4) == Flags.Reserved4) && fuelHatches != null)
		{
	...
	protected override void OnChildAdded(BaseEntity child)
	{
		...
		if (child.TryGetComponent<LootContainer>(out var component) && !(component is LockedByEntCrate) && base.isServer && Rust.Application.isLoadingSave)
		{
