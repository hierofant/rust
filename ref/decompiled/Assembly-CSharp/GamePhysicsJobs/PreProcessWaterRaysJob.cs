...
internal struct PreProcessWaterRaysJob : IJob
{
	...
	public NativeArray<RaycastCommand>.ReadOnly rays;
	...
	public void Execute()
	{
		...
		for (int i = 0; i < rays.Length; i++)
		{
			...
			{
				int value = num++;
				Ray value2 = new Ray(raycastCommand.from, raycastCommand.direction);
				...
				WaterMaxDists[value] = raycastCommand.distance;
