...
public static class PoolableEx
{
	...
	{
		Poolable componentInParent = gameObject.GetComponentInParent<Poolable>(includeInactive: true);
		if (componentInParent != null && componentInParent.prefabID != 0)
		{
			return componentInParent.gameObject != gameObject;
		}
		return false;
	}
