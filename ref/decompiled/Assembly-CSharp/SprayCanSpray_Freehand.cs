...
public class SprayCanSpray_Freehand : SprayCanSpray
{
	...
	public override void Save(SaveInfo info)
	{
		...
		{
			info.msg.sprayLine.linePoints = Facepunch.Pool.Get<List<LinePoint>>();
		}
	...
	private void Server_FinishEditing(RPCMessage msg)
	{
		...
		using SprayList sprayList = msg.read.Proto<SprayList>();
		...
		{
			if (linePoint.LocalPosition.IsNaNOrInfinity() || linePoint.WorldNormal.IsNaNOrInfinity())
			{
				Kill();
				return;
			}
