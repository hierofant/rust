...
public class HarborCraneContainerPickup : HarborCrane
{
	...
	public override void ServerInit()
	{
		...
		serverTowerGrabHandle = ServerTowerGrab.transformHandle;
		UpdateArm();
		SendNetworkUpdate();
	}
	...
	public override void Save(SaveInfo info)
	{
		...
		Vector3 vector = ((!BaseNetworkable.UseParallelSaves) ? ServerTowerGrab.localPosition : Facepunch.Extend.TransformEx.Unsafe.GetLocalPosMT(in serverTowerGrabHandle));
		info.msg.harborCrane.depth = vector.z;
	...
	private void UpdateArm()
	{
		...
		UpdateArmSupports(base.transform.right);
	}
}
