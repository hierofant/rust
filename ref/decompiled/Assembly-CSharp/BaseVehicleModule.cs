...
public class BaseVehicleModule : BaseVehicle, IPrefabPreProcess
{
	...
	public override bool OnRpcMessage(BasePlayer player, uint rpc, Message msg)
	{
		using (TimeWarning.New("BaseVehicleModule.OnRpcMessage"))
		{
			if (rpc == 2683376664u && player != null)
			{
				...
				{
					Debug.Log("SV_RPCMessage: " + player?.ToString() + " - RPC_Use");
				}
	...
	public override void VehicleFixedUpdate()
	{
		...
		using (TimeWarning.New("BaseVehicleModule.VehicleFixedUpdate"))
		{
	...
	public virtual Translate.Phrase CannotBeMovedNowReason()
	{
		return null;
	}
