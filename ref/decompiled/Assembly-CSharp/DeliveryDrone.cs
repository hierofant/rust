...
public class DeliveryDrone : Drone
{
	...
	public void Think()
	{
		...
		{
			return WaterLevel.GetWaterOrTerrainSurface(base.transform.TransformPoint(offset), waves: true, volumes: true);
		}
		bool IsAtGoToY()
		{
			if (_goToY.HasValue)
		...
		void SetState(State newState)
		{
			...
			flagsUpdateScope.Set(Flags.Reserved1, _state >= State.AscendBeforeReturn);
		}
	}
