...
public class SelectedItem : SingletonComponent<SelectedItem>, IInventoryChanged
{
	...
	public static readonly Translate.Phrase ChangeAccessoryTitle = new Translate.Phrase("changeAccessory", "Change Accessory");

	public static readonly Translate.Phrase ChangeAccessoryDesc = new Translate.Phrase("changeAccessoryDesc");
