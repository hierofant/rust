...
public class WildlifeTrap : StorageContainer
{
	...
	public void TrapWildlife(TrappableWildlife trapped)
	{
		...
		{
			Item item = ItemManager.Create(trapped.inventoryObject, UnityEngine.Random.Range(trapped.minToCatch, trapped.maxToCatch + 1), 0uL, isServerSide: true, 0uL);
