...
public class EventRecord : Pool.IPooled
{
	...
	public void EnterPool()
	{
		...
		{
			MemoryStream obj = datum.Bytes;
			if (obj != null)
			{
				Pool.FreeUnmanaged(ref obj);
			}
			List<int> obj2 = datum.Ints;
			if (obj2 != null)
			{
	...
	public EventRecord AddField(string key, BaseNetworkable entity)
	{
		...
		AddField(key, "_rot", transform.rotation.eulerAngles);
	...
	public void MarkSubmitted()
	{
		...
		{
			Debug.LogError($"EventRecord pooling error: event has been submitted ({TimesSubmitted}) a different amount of times than it was created ({TimesCreated})");
		}
	}
