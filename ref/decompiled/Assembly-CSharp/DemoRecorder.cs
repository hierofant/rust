...
public class DemoRecorder : SingletonComponent<DemoRecorder>
{
	...
	public static readonly Translate.Phrase overwritePhrase = new Translate.Phrase("demo.overwrite", "You are about to overwrite a demo with the same name as {0} - proceed?");
}
