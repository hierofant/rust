...
public class Chicken : BaseAnimalNPC
{
	...
	{
		if (base.isServer && Random.Range(0, 100) > 50 && base.transform != null && BaseNetworkable.HasCloseConnections(base.transform.position, 100f))
		{
			SpawnEgg();
		}
	}
	...
	public void SpawnEgg()
	{
		if (EggDefinition != null)
		{
			ItemManager.Create(EggDefinition, 1, 0uL, isServerSide: true, 0uL).Drop(base.transform.TransformPoint(EggDropLocalPos), -base.transform.forward);
		}
	}
