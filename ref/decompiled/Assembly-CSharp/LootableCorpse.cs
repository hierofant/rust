...
public class LootableCorpse : BaseCorpse, LootPanel.IHasLootPanel, IInventoryProvider
{
	...
	private void RPC_LootCorpse(RPCMessage rpc)
	{
		...
		if (!player || !player.CanInteract() || !CanLoot(player) || containers == null || Interface.CallHook("CanLootEntity", player, this) != null || !player.inventory.loot.StartLootingEntity(this))
		{
			return;
		}
