...
public class Pinata : BaseCombatEntity
{
	...
	public override void OnDied(HitInfo info)
	{
		...
		foreach (ItemAmount itemAmount in reward)
		{
			...
			{
				ItemManager.Create(itemAmount.itemDef, (int)itemAmount.amount, 0uL, isServerSide: true, 0uL).CreateWorldObject(DropPoint.position + UnityEngine.Random.onUnitSphere * UnityEngine.Random.Range(0f, DropPointRadius));
			}
		}
	}
}
