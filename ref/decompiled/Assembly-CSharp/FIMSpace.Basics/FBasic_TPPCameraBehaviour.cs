...
public class FBasic_TPPCameraBehaviour : MonoBehaviour
{
	...
	private void Start()
	{
		...
		targetSphericRotation = new Vector2(base.transform.eulerAngles.y, base.transform.eulerAngles.x);
	...
	private void Update()
	{
		...
		if ((Input.GetKey(KeyCode.Escape) || Input.GetKeyDown(KeyCode.Tab)) && Cursor.lockState == CursorLockMode.Locked)
		{
			HelperSwitchCursor();
		}
	...
	private void InputCalculations()
	{
		...
		if (rotateCamera && Cursor.lockState == CursorLockMode.Locked)
		{
