...
public struct VectorData : IEquatable<VectorData>, IProto<VectorData>, IProto
{
	[NonSerialized]
	public float x;
	...
	public static VectorData Deserialize(BufferStream stream, ref VectorData instance, bool isDelta)
	{
		...
		while (true)
		{
			...
			stream.ConsumeFieldOperation("ProtoBuf.VectorData");
			switch (num)
			{
			case 13:
				stream.ValidateFieldOrder(ref lastFieldId, 1u, fieldIsRepeated: false, "ProtoBuf.VectorData");
				instance.x = ProtocolParser.ReadSingle(stream);
				continue;
			case 21:
				stream.ValidateFieldOrder(ref lastFieldId, 2u, fieldIsRepeated: false, "ProtoBuf.VectorData");
				instance.y = ProtocolParser.ReadSingle(stream);
				continue;
			case 29:
				stream.ValidateFieldOrder(ref lastFieldId, 3u, fieldIsRepeated: false, "ProtoBuf.VectorData");
			...
			case 3u:
				...
				break;
			default:
				stream.ValidateFieldOrder(ref lastFieldId, key.Field, fieldIsRepeated: true, "ProtoBuf.VectorData");
				ProtocolParser.SkipKey(stream, key);
				break;
			}
		}
